...
const base = __dirname + "/../../deep/folder/dest/"
describe("should have correctly create folderProxyA proxy in deep/folder/dest", () => {
  ...
  test("should have create package.json with correct content", async () => {
    ...
    expect(JSON.parse(file)).toEqual({
      ...
      name: "consumer/deep/folder/dest/folderProxyA",
      private: true,
...
describe("should have correctly create folderProxyB proxy in deep/folder/dest", () => {
  ...
  test("should have create package.json with correct content", async () => {
    ...
    expect(JSON.parse(file)).toEqual({
      ...
      name: "consumer/deep/folder/dest/folderProxyB",
      private: true,
